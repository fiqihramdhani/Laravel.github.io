...
@method('put')
  <div class="mb-3">
   ...
   @endif
    ...
    <input type="file" class="form-control  @error('Img') is-invalid @enderror " id="image"   name="img" autofocus value="{{ old('img' , $Post->img) }}" onchange="previewImage()" required>
    @error('Img')
        <div class="invalid-feedback">
        {{ $message }}
        </div>
   ...
   <div class="mb-3">
    ...
    <input type="text" class="form-control @error('Judul_Posting') is-invalid @enderror" id="judul-posting"  name="Judul_Posting" value="{{ old('Judul_Posting', $Post->Judul_Posting) }}" required>
    @error('Judul_Posting')
        <div class="invalid-feedback">
        {{ $message }}
        </div>
